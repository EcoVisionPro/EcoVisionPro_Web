// ================================================================
// EcoVision Pro - FIXED Dashboard (Proper ThingsBoard + Demo)
// ================================================================
...
function connectThingsBoard() {
    try {
        ...
        websocket.onclose = () => {
            ...
            if (!config.isDemoMode && reconnectAttempts < 10) {
                reconnectAttempts++;
                setTimeout(connectThingsBoard, 5000);
            }
        };
    } catch (error) {
...
function initCharts() {
    ...
    charts.voltage = createChart('voltageChart', 'Voltage (V)', config.chartColors.voltage);
    charts.current = createChart('currentChart', 'Current (A)', config.chartColors.current);
    charts.power = createChart('powerChart', 'Power (W)', config.chartColors.power);
...
window.addEventListener('DOMContentLoaded', () => {
    console.log("🚀 EcoVision Pro Dashboard Loading...");
    initCharts();
...
console.log("📊 EcoVision Pro Dashboard v2.0");
